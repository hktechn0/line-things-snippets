...
/**
 * BLE Temperature & Pressure & Humidity Sensor using BME280
 * https://github.com/adafruit/Adafruit_BME280_Library
 */

// Device Name: Maximum 30 bytes
#define DEVICE_NAME "BME280 Sensor - nRF52"
...
void loop() {
  if (refreshSensorValue) {
    ...
    uint16_t humidityValue = bme.readHumidity() * 100;
    ...
    Serial.print(pressureValue / 1000.0);
    Serial.println(" hPa");
