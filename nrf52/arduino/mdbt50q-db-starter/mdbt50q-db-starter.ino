...
/**
 * LINE Things Starter for Raytac MDBT50Q-DB
 * http://www.raytac.com/product/ins.php?index_id=81
 * 
 * Please use "Adafruit_nRF52_Arduino" board library and select "nRF52840DK PCA10056"
