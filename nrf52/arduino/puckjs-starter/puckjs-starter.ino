 ...
 * 
 * See following instruction for setting up bootloader and Arduino
 * https://qiita.com/hktechno/items/254ff58522b5bb512305
 */

// Device Name: Maximum 30 bytes
#define DEVICE_NAME "LINE Things Trial Puck.js"
...
void write_led_cb(uint16_t conn_hdl, BLECharacteristic* chr, uint8_t* data, uint16_t len) {
  int value = *data;
